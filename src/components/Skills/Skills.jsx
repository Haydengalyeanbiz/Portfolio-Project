...
export const Skills = () => {
	// Animation variants for seamless infinite looping carousel
	const carouselVariants = {
		animate: {
			x: ['0%', '-50%'], // Move from 0% to -50% (half the width to loop seamlessly)
			transition: {
				x: {
					repeat: Infinity,
					repeatType: 'loop',
		...
		<motion.div className='skills-wrapper'>
			...
			<div className='skills-carousel'>
				...
				>
					...
					{/* Duplicate set of badges to make it seamless */}
					<div className='skills-group'>
						<img
							src='https://img.shields.io/badge/React-%2320232a.svg?style=for-the-badge&logo=react&logoColor=%2361DAFB'
							alt='React Badge'
